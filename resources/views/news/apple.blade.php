<x-layout title="Top Apple Headlines">
    <div class="container mt-5">
        <h1 class="text-white py-3">Top <span class="text-yellow">Apple</span> Headlines</h1>
        <div class="row">
            @foreach($headlines as $headline)
            <div class="col-md-4 mb-4">
                <div class="card">
                    @if($headline->urlToImage)
                    <img src="{{ $headline->urlToImage }}" class="card-img-top img-fluid" alt="{{ $headline->title }}">
                    @endif
                    <div class="card-body">
